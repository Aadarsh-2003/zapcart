    ...
    <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            ...
                            <img src={i<4 ? assets.star_icon : assets.star_dull_icon} alt='star_icon' />
                        ))}
            ...
            <div className='flex flex-col items-center mt-20' >
                    <div className='flex flex-col items-center w-max' >
                        ...
                        <div id='primary' className='w-20 h-0.5 rounded-full mt-2 ' ></div>
                    </div>
                    ...
                    <button onClick={()=> {
                        navigate('/products');
                        scrollTo(0,0);
                    }} className='mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-emerald-400 hover:bg-emerald-400/10 transition' >See more</button>
            </div>
        </div>
  )
};
